...
{ TRectFAnimation }
  ...
  TAnimatorHelper = class helper for TAnimator
    ...
    class procedure AnimateFloatDelayWithFinish(const Target: TFmxObject; const APropertyName: string; const NewValue: Single; Delay: Single; Finish: TProc; Duration: Single = 0.2; AType: TAnimationType = TAnimationType.in; AInterpolation: TInterpolationType = TInterpolationType.Linear); overload;
  end;
...
class procedure TAnimatorHelper.AnimateFloatDelayWithFinish(const Target: TFmxObject; const APropertyName: string; const NewValue: Single; Delay: Single; Finish: TProc; Duration: Single; AType: TAnimationType; AInterpolation: TInterpolationType);
var
  Animation: TFloatAnimation;
begin
  StopPropertyAnimation(Target, APropertyName);
